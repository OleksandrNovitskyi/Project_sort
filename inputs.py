...
def read_file(f_name):
    """Read .csv file and return list of lists with data and first row (titles)"""
...
def input_black_list():
    """Read Google Sheet black list and return list of first_names, list of last_names and list of positions
